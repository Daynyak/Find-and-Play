...
function PlaygroundCertainFromJSON(json) {
    return PlaygroundCertainFromJSONTyped(json, false);
}
exports.PlaygroundCertainFromJSON = PlaygroundCertainFromJSON;
function PlaygroundCertainFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PlaygroundCertainFromJSONTyped = PlaygroundCertainFromJSONTyped;
function PlaygroundCertainToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PlaygroundCertainToJSON = PlaygroundCertainToJSON;
